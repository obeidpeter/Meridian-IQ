...
| -------- | -------------------------------------- | --------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------- |
| P1       | Oversized role pages                   | Clerk, portfolio, SME invoice detail/dashboard exceed 2,000 lines; max complexity 148 (the Clerk health page was split in R110 into nine modules, the largest 495 lines; the console portfolio page in R117 into fifteen, the shell 609 lines) | Split by route section and state domain; lazy-load secondary panels; preserve keyboard/focus behavior | No production page over 1,500 lines; affected journeys and screenshots green      |
