...
const PINNED: Record<string, PinnedPolicy> = {
  ...
  "clerk_advisory_briefs/meridian_clerk_tenant": { cmd: "ALL", roles: "public", qual: "5074b35259440c75", withCheck: "5074b35259440c75" },
  ...
  "clerk_memory_embeddings/meridian_clerk_tenant": { cmd: "ALL", roles: "public", qual: "5074b35259440c75", withCheck: "5074b35259440c75" },
  ...
  "clerk_retrieval_eval_runs/meridian_bypass_only": { cmd: "ALL", roles: "public", qual: "f4fc01217632ad30", withCheck: "f4fc01217632ad30" },
  "client_onboarding_runs/meridian_tenant_isolation": { cmd: "ALL", roles: "public", qual: "5074b35259440c75", withCheck: "5074b35259440c75" },
  // 0045 (D12): the same firm-keyed predicate as the onboarding runs.
  "client_assignments/meridian_tenant_isolation": { cmd: "ALL", roles: "public", qual: "5074b35259440c75", withCheck: "5074b35259440c75" },
  ...
  "operational_heartbeats/meridian_operational_bypass": { cmd: "ALL", roles: "public", qual: "f4fc01217632ad30", withCheck: "f4fc01217632ad30" },
