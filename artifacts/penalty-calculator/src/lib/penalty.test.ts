...
const FIXTURES: Array<{
...
}> = [
  {
    ...
    input: {
      ...
      daysAccessNotGranted: 0,
      nonCompliantInvoiceCount: 0,
    },
  ...
  },
  {
    ...
    input: {
      annualTurnover: 10_000_000,
      daysAccessNotGranted: 1,
      nonCompliantInvoiceCount: 3,
    },
    // s103 = 1_000_000 ; s104 = 3 * 25_000 = 75_000 ; total = 1_075_000
    expected: {
      band: "small",
      section103: 1_000_000,
      section104: 75_000,
      total: 1_075_000,
    },
  },
  ...
  },
  {
    ...
    input: {
      ...
      daysAccessNotGranted: 30,
      nonCompliantInvoiceCount: 100,
    },
    // s103 = 1_000_000 + 10_000*29 = 1_290_000 ; s104 = 100 * 100_000 = 10_000_000 ; total = 11_290_000
    expected: {
      band: "large",
      section103: 1_290_000,
      section104: 10_000_000,
      total: 11_290_000,
    },
  },
  {
    ...
    input: {
      annualTurnover: SMALL_TURNOVER_CEILING,
      daysAccessNotGranted: 0,
      nonCompliantInvoiceCount: 1,
    },
    expected: {
      band: "small",
      section103: 0,
  ...
  },
  {
    ...
    input: {
      annualTurnover: SMALL_TURNOVER_CEILING + 1,
      daysAccessNotGranted: 0,
      nonCompliantInvoiceCount: 1,
    },
    expected: {
  ...
  },
  {
    ...
    input: {
      annualTurnover: MEDIUM_TURNOVER_CEILING,
      daysAccessNotGranted: 0,
      nonCompliantInvoiceCount: 1,
    },
    expected: {
  ...
  },
  {
    ...
    input: {
      annualTurnover: MEDIUM_TURNOVER_CEILING + 1,
      daysAccessNotGranted: 0,
      nonCompliantInvoiceCount: 1,
    },
    expected: {
