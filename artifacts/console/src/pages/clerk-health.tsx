...
// decision ledger was automation-driven. Pure ledger SQL server-side; the
// operator acts on a paused policy from the per-client surfaces. Renders
// only when the firm has any automation footprint at all.
    ...
    <Card data-testid="card-automation-rollup">
      ...
      <CardContent className="space-y-3">
        ...
        <p className="text-xs text-muted-foreground">
          ...
          resolve them from the client&apos;s own actions card.
        </p>
      </CardContent>
    </Card>
  );
