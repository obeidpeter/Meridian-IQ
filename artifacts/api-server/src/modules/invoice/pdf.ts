...
export async function renderInvoicePdf(
  ...
  doc
    ...
    .fontSize(9)
    .fillColor("#666666")
    .text("E-invoicing compliance by Valo", MARGIN + 52, headerY + 24, {
      width: 280,
    });
  doc
    .font("Helvetica-Bold")
  ...
  doc.text(
    `Generated by Valo for ${brandName} · ${supplier.legalName} · ${invoice.invoiceNumber}`,
    MARGIN,
